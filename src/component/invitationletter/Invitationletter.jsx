...
function Invitationletter() {
  ...
  return (
    <div className="invitationletter">
      ...
      <div className="invitationletter-title">
        THAM DỰ LỄ CƯỚI CỦA HÙNG & HẰNG
      </div>
        ...
        <div className="flex items-center justify-center w-full gap-8">
          ...
          <div className="flex flex-col items-center justify-center flex-1">
            ...
            <div className="info-lunar">
              (Tức Ngày 18 Tháng 09 Năm Giáp Thìn)
            </div>
            <button className="invitation-btn">Gửi Mừng Cưới</button>
          </div>
